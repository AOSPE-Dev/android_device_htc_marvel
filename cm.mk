...
BUILD_ID := MARVELLOUS-CM-11.0-$(shell date -u +%d%m%Y)

# Set build fingerprint / ID / Product Name ect.
PRODUCT_BUILD_PROP_OVERRIDES += PRODUCT_NAME=htc_marvel BUILD_ID=$(BUILD_ID) BUILD_DISPLAY_ID=$(BUILD_ID) BUILD_FINGERPRINT=cyanogenmod/htc_marvel/marvel:4.4.2/$(BUILD_ID)/v0.2:user/release-keys 
PRODUCT_RELEASE_NAME := MARVELLOUS-CM-11.0
